...
def post_generation(input_filename, output_filename):
    ...
    for post in tqdm(posts):
        ...
        data_res_dict = {
            "Post": post,
            "Transferred_Post_llama2:70B": result_str
        }
...
output_folder = f"/home/qiang/projects/Digital_mental_health/Tasks/Style_transfer_task/methods/llama2:70B/transfered/"
